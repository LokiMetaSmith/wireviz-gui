...
class TestMenuStructure(unittest.TestCase):
    ...
    def test_file_menu_structure(self):
        with patch.dict(sys.modules, {'tkinter': FakeTkModule}):
            ...
            labels = [kwargs.get('label') for method, kwargs in menu.calls if method == 'add_command']
            ...
            # Check Submenus
            cascade_labels = [kwargs.get('label') for method, kwargs in menu.calls if method == 'add_cascade']
            ...
            export_labels = [kwargs.get('label') for method, kwargs in export_menu.calls if method == 'add_command']
